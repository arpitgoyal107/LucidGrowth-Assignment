...
const API_URL = "https://portfolio-assignment-backend.onrender.com/skills";
...
const Skills = ({ skills, setSkills }) => {
  ...
  return (
    <div className="skills-list p-4">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-12 text-center">
        {skills.map((skill) => (
          <div
            key={skill._id}
            ...
            <div className="card-body">
              {editingSkill === skill._id ? (
                ...
                <>
                  ...
                  <p className="text-gray-600 mb-1">Level: {skill.level}</p>
